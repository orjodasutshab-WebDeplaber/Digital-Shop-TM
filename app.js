...
.shop-name{font-size:3.25em;font-weight:800;color:#fff;letter-spacing:-0.3px}
.shop-sub{font-size:1.75em;color:#6366f1;font-weight:600;letter-spacing:1.5px;text-transform:uppercase}
.top-bar-right{display:flex;flex-direction:column;align-items:flex-end;gap:4px}
.order-label{font-size:1.6em;color:#64748b;letter-spacing:.5px;text-transform:uppercase}
.order-num{font-size:2.75em;font-weight:800;color:#818cf8;letter-spacing:-0.5px}
...
.pay-label{font-size:1.75em;color:#94a3b8;text-transform:uppercase;letter-spacing:.8px;display:block;margin-bottom:5px;font-weight:600}
.pay-status{font-size:3.5em;font-weight:800;color:${statusColor};line-height:1}
.status-badge{background:${statusColor};color:#fff;padding:0.625em 1.375em;border-radius:50px;font-size:2em;font-weight:800;white-space:nowrap;box-shadow:0 4px 15px ${statusColor}55;letter-spacing:.3px}
...
.sec-head-text{font-size:1.75em;font-weight:800;color:#818cf8;text-transform:uppercase;letter-spacing:.8px}
...
.ikey{font-size:2em;color:#64748b;flex-shrink:0;font-weight:500}
.ival{font-size:2em;color:#e2e8f0;font-weight:700;text-align:right;word-break:break-word;max-width:62%}
...
.plabel{font-size:2.125em;color:#94a3b8;font-weight:500}
.pamount{font-size:2.125em;color:#e2e8f0;font-weight:700}
...
.price-row.total-row .plabel{font-size:2.375em;font-weight:800;color:#c7d2fe}
.price-row.total-row .pamount{font-size:4em;font-weight:800;color:#818cf8;letter-spacing:-1px}
...
.step-label{font-size:1.625em;color:#475569;text-align:center;line-height:1.4;font-weight:600}
.step-label.done{color:#10b981}
.step-label.active{color:#818cf8;font-weight:800}
.rejected-box{margin-top:16px;background:rgba(239,68,68,0.08);border:1px solid rgba(239,68,68,0.25);border-radius:12px;padding:0.875em 1em;font-size:2em;color:#f87171;text-align:center;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px}
...
.note-text{font-size:1.875em;color:#fbbf24;line-height:1.6;font-weight:500}
...
.barcode-id{font-size:1.625em;color:#475569;letter-spacing:4px;margin-top:6px;font-weight:600}
.footer-note{font-size:1.75em;color:#334155;line-height:1.8;font-weight:500}
