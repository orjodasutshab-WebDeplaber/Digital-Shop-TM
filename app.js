...
function pmxOpenBuyModal(productId) {
    ...
    const _mobFieldsHtml = _fields.map((f, i) => `
        <input id="pmxExtraField_${i}" placeholder="${f}"
          style="width:100%;padding:26px 20px;border-radius:14px;border:2px solid ${inputBdr};background:${inputBg};color:${inputClr};margin-bottom:16px;box-sizing:border-box;font-family:'Hind Siliguri',sans-serif;font-size:55px;font-weight:700;outline:none;min-height:110px;"
          onfocus="this.style.borderColor='#6366f1'" onblur="this.style.borderColor='${inputBdr}'">`).join('');
    ...
    <div style="padding:16px;background:${pageBg};">
      ...
      <div style="background:${sectionBg};border:1.5px solid ${sectionBdr};border-radius:16px;padding:16px;">
        ...
        <input id="pmxBuyTrxId" placeholder="TrxID দিন (অবশ্যই) *"
          style="width:100%;padding:26px 20px;border-radius:14px;border:2px solid #6366f1;background:${inputBg};color:${inputClr};margin-bottom:16px;box-sizing:border-box;font-family:'Hind Siliguri',sans-serif;font-size:55px;font-weight:700;outline:none;min-height:110px;"
          onfocus="this.style.borderColor='#818cf8'" onblur="this.style.borderColor='#6366f1'">
        <button onclick="pmxPlaceOrder('${p.id}')"
